  ...
  return (
    <div className="flex flex-col justify-center items-center bg-[#363636] py-10 w-full h-full">
      ...
      <div className="md:flex flex-col md:text-start text-center gap-6 mt-10">
        <form action="" className="md:flex flex flex-col gap-6">
          <select className="flex gap-4 w-72 rounded md:text-2xl text-xs px-4 md:py-0 py-2">
        ...
        <Button className="bg-primary text-slate-100 border-0 rounded md:mt-0 mt-10">
          SEARCH NOW
        </Button>
      </div>
    </div>
